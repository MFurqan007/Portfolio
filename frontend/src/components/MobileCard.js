...
export default function MobileCard() {
  ...
  return (
    <div className='w-full h-full flex justify-center items-center'>
        <div 
            className={`relative card ${activeCard? 'rotate-y-180':''}`}
        >
            {/* {front} */}
            <div className=' backface-hidden'>
                <div className='w-[80vw] h-[80vh] rounded-[10px] flex flex-col'>
                    <div className='w-full h-[35vh] rounded-t-[10px] bg-[#383838] flex justify-center items-end'>
                        <Image
                            src={ProfileImg}
                            className='w-[15rem] h-[12rem]'
                        />
                    </div>
                    <div className='w-full h-[55vh] bg-[#1A1B21] flex flex-col justify-evenly items-center'>
                        <div className='w-auto h-auto text-center'>
                            <p className=' font-sans text-[2rem] font-bold text-[white]'>M. Furqan Nasir</p>
                            <p className='mt-[5px] font-sans text-[1rem] font-[400] text-[#F3BF99]'>MERN Stack Developer</p>
                            <p className='mt-[5px] font-sans text-[1rem] font-[400] text-[#b790c0]'>DevOps Engineer</p>
                        </div>
                        <div className='w-5/6 h-auto mt-[20px] flex justify-between items-center'>
                            <div 
                                className='w-[48%] h-[3.5rem] bg-[white] rounded-[5px] flex justify-center items-center hover:cursor-pointer'
                                onClick={handleMobEmailClick}
                            >
                                <IoMail className='w-[20px] h-[20px]'/>
                                <p className='ml-[5px] text-[#374151] font-sans text-[1rem] font-[500]'>Email</p>
                            </div>
                            <Link 
                                href={"https://www.linkedin.com/in/muhammad-furqan-nasir-779562244"} 
                                passHref={true}
                                className='w-[48%] h-[3.5rem] rounded-[5px]'
                            >
                                <div className='w-full h-full rounded-[5px] bg-[#5093E2] flex justify-center items-center hover:cursor-pointer'>
                                    ...
                                    <p className='ml-[5px] text-[white] font-sans text-[1rem] font-[500]'>LinkedIn</p>
                                </div>
                            </Link>
                            
                        </div>
                        <div 
                            className='w-full px-[1rem] h-auto mt-[10px] flex justify-end items-center'
                            onClick={handleFlip}    
                        >
                            <p className='text-[white] font-sans text-[1.5rem] font-[300]'>Tap</p>
                            <MdDoubleArrow className='ml-[15px] text-white w-[4rem] h-[5rem] animate-pulse'/>
                        </div>
                        

                    </div>
                    <div className='w-full h-[10vh] rounded-b-[10px] bg-[#161619] flex justify-center items-center'>
                        <div className=' w-7/12 h-auto flex justify-between items-center'>
                            <Link 
            ...
            {/* {back} */}
            <div className='absolute w-[80vw] h-[80vh] bg-[#1A1B21] rounded-[10px] top-0 backface-hidden rotate-y-180'>
                <div 
                    className='w-full h-full flex flex-col justify-center items-center'
                    onClick={handleFlip}
                >
                    <QrCode/>
                    <div className='w-auto h-auto mt-[20px]'>
                        <p className='text-[white] font-sans text-[2rem] font-[500]'>QR Code</p>
                    </div>
                </div>
            </div>
        </div>
