    ...
    <div className='w-screen h-screen flex justify-center items-center'>
        ...
        >
            ...
            <div className=' backface-hidden'>
                <div className='w-[240px] h-[450px] rounded-[10px] flex flex-col'>
                    <div className='w-full h-[180px] rounded-t-[10px] bg-[#383838] flex justify-center items-end'>
                        <Image
                            src={ProfileImg}
                            className='w-[200px] h-[160px]'
                        />
                    </div>
                    <div className='w-full h-[225px] bg-[#1A1B21] flex flex-col justify-start items-center'>
                        <div className='w-auto h-auto mt-[25px]'>
                            <p className=' font-sans text-[25px] font-bold text-[white]'>Furqan Nasir</p>
                        </div>
                        <div className='w-auto h-auto mt-[5px]'>
                            <p className='font-sans text-[13px] font-[400] text-[#F3BF99]'>MERN Stack Developer</p>
                        </div>
                        <div className='w-auto h-auto mt-[5px]'>
                            <p className='font-sans text-[13px] font-[400] text-[#b790c0]'>DevOps Engineer</p>
                        </div>
                        <div className='w-5/6 h-auto mt-[20px] flex justify-between items-center'>
                            <div 
                                className='w-[48%] h-[35px] bg-[white] rounded-[5px] flex justify-center items-center hover:cursor-pointer'
                                onClick={handleMobEmailClick}
                            >
                                <IoMail className='w-[18px] h-[18px]'/>
                                <p className='ml-[5px] text-[#374151] font-sans text-[14px] font-[500]'>Email</p>
                            </div>
                            <Link 
                                href={"https://www.linkedin.com/in/muhammad-furqan-nasir-779562244"} 
                                passHref={true}
                                className='w-[48%] h-[35px] rounded-[5px]'
                            >
                                <div className='w-full h-full rounded-[5px] bg-[#5093E2] flex justify-center items-center hover:cursor-pointer'>
                                    ...
                                    <p className='ml-[5px] text-[white] font-sans text-[14px] font-[500]'>LinkedIn</p>
                                </div>
                            </Link>
                        ...
                        >
                            ...
                            <MdDoubleArrow className='ml-[15px] text-white w-[30px] h-[40px] animate-pulse'/>
                        </div>
                        

                    </div>
                    <div className='w-full h-[45px] rounded-b-[10px] bg-[#161619] flex justify-center items-center'>
                        <div className=' w-3/5 h-auto flex justify-between items-center'>
                            <Link 
            ...
            {/* {back} */}
            <div className='absolute top-0 backface-hidden rotate-y-180'>
                <div 
                    className='w-[230px] h-[450px] bg-[#1A1B21] rounded-[10px] flex flex-col justify-center items-center'
                    onClick={handleFlip}
                >
                    <QrCode/>
                    <div className='w-auto h-auto mt-[20px]'>
                        <p className='text-[white] font-sans text-[28px] font-[500]'>QR Code</p>
                    </div>
                </div>
            </div>
        </div>
